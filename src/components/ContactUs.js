      ...
      <div className="contact-div">
        ...
        <div className="contact-form-div">
          ...
          <form className="contact-form" action="https://formspree.io/f/manjjnvb" method="POST">
            ...
            <button style={{ width: "100%" }} className="btn btn-primary contact-form-submit"> Submit request </button>
          </form>
        </div>
      </div>
      <div className="contact-info-container">
        ...
        <div className="contact-info-cards">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"id="email" >
            <path fill="none" d="M0 0h24v24H0V0z"></path>
            <path fill="var(--logo)" d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0l-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z"></path>
          </svg>{" "}
          &nbsp;
          <b>Email us</b> <br /> bluewaveexports777@gmail.com
        </div>
        <div className="contact-info-cards">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="location" >
            <path fill="var(--logo)" d="M12,2a8,8,0,0,0-8,8c0,5.4,7.05,11.5,7.35,11.76a1,1,0,0,0,1.3,0C13,21.5,20,15.4,20,10A8,8,0,0,0,12,2Zm0,17.65c-2.13-2-6-6.31-6-9.65a6,6,0,0,1,12,0C18,13.34,14.13,17.66,12,19.65ZM12,6a4,4,0,1,0,4,4A4,4,0,0,0,12,6Zm0,6a2,2,0,1,1,2-2A2,2,0,0,1,12,12Z"></path>
          </svg>
          <b> Address</b> <br />
          Siddharth Nagar, <br />
        ...
        <div className="contact-info-cards contact-card-fax">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="fax-machine" >
            <g>
              ...
              <path fill="var(--logo)" d="M7,32H3a3,3,0,0,1-3-3V9A3,3,0,0,1,3,6H7a3,3,0,0,1,3,3V29A3,3,0,0,1,7,32ZM3,8A1,1,0,0,0,2,9V29a1,1,0,0,0,1,1H7a1,1,0,0,0,1-1V9A1,1,0,0,0,7,8Z" ></path>
              <path fill="var(--logo)" d="M30,30H13a1,1,0,0,1,0-2H30V10H10V29a1,1,0,0,1-2,0V9A1,1,0,0,1,9,8H30a2,2,0,0,1,2,2V28A2,2,0,0,1,30,30Z" ></path>
              <path fill="var(--logo)" d="M25 18H15a1 1 0 01-1-1V13a1 1 0 011-1H25a1 1 0 011 1v4A1 1 0 0125 18zm-9-2h8V14H16zM16 22a1 1 0 111-1A1 1 0 0116 22zM20 22a1 1 0 111-1A1 1 0 0120 22zM24 22a1 1 0 111-1A1 1 0 0124 22zM16 26a1 1 0 111-1A1 1 0 0116 26zM20 26a1 1 0 111-1A1 1 0 0120 26zM24 26a1 1 0 111-1A1 1 0 0124 26z" ></path>
              <path fill="var(--logo)" d="M22,6H18a1,1,0,0,1,0-2h4a1,1,0,0,1,0,2Z" ></path>
            </g>
          </svg>
          &nbsp;
