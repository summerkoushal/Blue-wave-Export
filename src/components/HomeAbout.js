...
export default function HomeAbout() {
  return (
      <div style={{display:'flex', flexDirection: 'row', justifyContent: 'space-evenly', marginTop: '50px', marginBottom: '50px'}} className='container'>
          <img style={{width: '45%', height: '100%', alignSelf: 'flex-start'}} src="pulses.jpg" alt="" />
          <div style={{ width: '45%', backgroundColor: 'whitesmoke', padding: '30px' }} >
            <h4 style={{color: 'orange'}} >About</h4>
              <h2>UMA EXPORTS</h2>
